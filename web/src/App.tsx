...
import type { AuditView, DataHealthView, GateView, OverviewView, PortfolioView, RiskView, TradeLeadView, WatchlistView } from './lib/models';
...
type Page = 'overview' | 'leads' | 'watchlist' | 'portfolio' | 'risk' | 'gates' | 'health' | 'audit';

const NAV: Array<[Page, string]> = [
  ['overview','Overview'], ['leads','Trade Leads'], ['watchlist','Watchlist'], ['portfolio','Portfolio'],
  ['risk','Risk'], ['gates','Phase Gates'], ['health','Data Health'], ['audit','Audit Trail']
];
