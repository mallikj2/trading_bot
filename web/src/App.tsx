...
import type { AuditView, DataHealthView, GateView, OverviewView, PortfolioView, RiskView, StrategyValidationView, TradeLeadView, WatchlistView, ExperimentReportingView, IncidentReportingView } from './lib/models';
...
type Page = 'overview' | 'leads' | 'watchlist' | 'portfolio' | 'risk' | 'validation' | 'experiments' | 'incidents' | 'gates' | 'health' | 'audit';

const NAV: Array<[Page, string]> = [
  ['overview','Overview'], ['leads','Trade Leads'], ['watchlist','Watchlist'], ['portfolio','Portfolio'],
  ['risk','Risk'], ['validation','Validation'], ['experiments','Experiments'], ['incidents','Incidents'], ['gates','Phase Gates'], ['health','Data Health'], ['audit','Audit Trail']
];
