...
import type { AuditView, DataHealthView, GateView, OverviewView, PortfolioView, RiskView, StrategyValidationView, TradeLeadView, WatchlistView } from './lib/models';
...
type Page = 'overview' | 'leads' | 'watchlist' | 'portfolio' | 'risk' | 'validation' | 'gates' | 'health' | 'audit';

const NAV: Array<[Page, string]> = [
  ['overview','Overview'], ['leads','Trade Leads'], ['watchlist','Watchlist'], ['portfolio','Portfolio'],
  ['risk','Risk'], ['validation','Validation'], ['gates','Phase Gates'], ['health','Data Health'], ['audit','Audit Trail']
];
